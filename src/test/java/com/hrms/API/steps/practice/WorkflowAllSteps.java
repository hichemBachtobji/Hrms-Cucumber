...
public class WorkflowAllSteps {
	...
	public void the_employee_ID_is_stored_as_a_global_variable_to_be_used_for_other(String empID) {
	...
	public void the_retrieved_employee_ID_at_matches_the_globally_stored_employee_Id(String value) {
		...
		// empID.contentEquals(employeeID);
	...
	public void the_retrieved_data_at_matches_the_data_used_to_create_an_employee_with_employee_ID(String employee,
